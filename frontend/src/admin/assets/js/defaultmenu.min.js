...
(() => {
  ...
  //     }
  //   } else {
  //     console.warn("mainContent is null. Ensure the element exists in the HTML.");
  //   }
  ...
  if (
    !localStorage.getItem("xyntralayout") &&
    !localStorage.getItem("xyntranavstyles") &&
...
function ResizeMenu() {
  ...
  checkHoriMenu();
  if (WindowPreSize[WindowPreSize.length - 1] >= 992 && localStorage.xyntranavstyles == 'menu-click') {
