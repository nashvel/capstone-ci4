...
function checkAllFn() {
    if (checkAll.checked) {
        document.querySelectorAll('.leads-checkbox input').forEach(function (e) {
            e.closest('.leads-list').classList.add('selected');
            e.checked = true;
        });
    }
    else {
        document.querySelectorAll('.leads-checkbox input').forEach(function (e) {
            e.closest('.leads-list').classList.remove('selected');
            e.checked = false;
        });
    }
=======
