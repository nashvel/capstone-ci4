...
(function () {
    ...
    var options = {
        ...
        colors: ["rgb(227, 84, 212)", "rgb(92, 103, 247)"],
        stroke: {
            show: true,
            curve: 'smooth',
            lineCap: 'round',
        ...
        fill: {
            ...
            gradient: {
                type: 'horizontal',
                shadeIntensity: 0.5,
                gradientToColors: ['rgb(92, 103, 247)'],
                inverseColors: true,
                opacityFrom: 1,
                opacityTo: 1,
                stops: [0, 100]
    ...
    var options = {
        ...
        colors: ["rgba(var(--primary-rgb),0.8)", "rgba(227, 84, 212, 0.8)", "rgba(255, 93, 159, 0.8)", "rgba(255, 142, 111, 0.8)"],
    };
    ...
    var options = {
        ...
        chart: {
            ...
            dropShadow: {
                ...
                left: 0,
                blur: 6,
                color: ['rgb(227, 84, 212)',"rgba(var(--primary-rgb))"],
                opacity: 0.3
            },
            toolbar: { show: false }
        },
        ...
        colors: ["rgb(227, 84, 212)","rgba(var(--primary-rgb))"],
        yaxis: {
        },
        xaxis: {
            type: 'week',
    ...
    var chart = {
        ...
        colors: ["rgb(158, 92, 247)", "rgba(var(--primary-rgb))"],
        plotOptions: {
            bar: {
                horizontal: false,
                columnWidth: "45%",
    ...
    var options1 = {
        ...
        colors: [ "rgba(var(--primary-rgb))", "rgb(227, 84, 212)", "rgb(255, 142, 111)", "rgb(255, 93, 159)"],
        plotOptions: {
          bar: {
            horizontal: false,
            columnWidth: "20%",
